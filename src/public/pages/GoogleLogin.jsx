    ...
    return (
        <main className="flex min-h-[70vh] items-center justify-center px-4 py-16">
            <section className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-7 text-center shadow-lift sm:p-10">
                ...
                <h1 className="mt-6 font-display text-2xl font-bold text-slate-900">Welcome to Edison Shop</h1>
                ...
                <p className="mt-7 flex items-center justify-center gap-2 text-xs text-slate-400"><ShieldCheck size={14} className="text-emerald-600" /> Your Google password is never shared with Edison Shop.</p>
            </section>
        </main>
    );
}
